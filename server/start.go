...
`,
	...
	cmd.Flags().Bool(srvflags.RPCEnable, true, "Defines if Cosmos-sdk REST server should be enabled")
	cmd.Flags().Bool(srvflags.EnabledUnsafeCors, true, "Defines if CORS should be enabled (unsafe - use it at your own risk)")
